...
public class SynthaticAnalyzer extends ChainedCall {
	...
	private SynthaticAnalyzer() {
			...
			this.functions.put("<ExpressaoLR>", tokens -> {
				...
				SynthaticNode tokenMap = new SynthaticNode();
				Token token = tokens.peek();
				if (token != null && "start".equals(token.getLexeme())) {tokenMap.add(new SynthaticNode(tokens.remove()));}if (token != null && "(".equals(token.getLexeme())) {tokenMap.add(new SynthaticNode(tokens.remove()));}if (token != null && ")".equals(token.getLexeme())) {tokenMap.add(new SynthaticNode(tokens.remove()));}if (token != null && "{".equals(token.getLexeme())) {tokenMap.add(new SynthaticNode(tokens.remove()));}tokenMap.add(this.call("<Corpo>", tokens).getTokenNode());
					if (token != null && "}".equals(token.getLexeme())) {tokenMap.add(new SynthaticNode(tokens.remove()));}}return tokenMap;});
...

	{
				SynthaticNode tokenMap = new SynthaticNode();
				Token token = tokens.peek();
				if (token != null && "return".equals(token.getLexeme())) {tokenMap.add(new SynthaticNode(tokens.remove()));}tokenMap.add(this.call("<CodigosRetornos>", tokens).getTokenNode());
					}return tokenMap;});

	this.functions.put("<Condicional>",tokens->{
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(token!=null&&"if".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}if(token!=null&&"(".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<ExpressaoLogicaRelacional>",tokens).getTokenNode());if(token!=null&&")".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<Corpo>",tokens).getTokenNode());if(token!=null&&"}".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<CondEnd>",tokens).getTokenNode());}return tokenMap;});

	this.functions.put("<IdentificadorAritmetico>",tokens->{
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(this.predict("<Escopo>",tokens.peek()))
	{
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(this.predict("<IdentificadorSemFuncao>",tokens.peek()))
	{
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(token!=null&&"Id".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}if(token!=null&&"true".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}if(token!=null&&"false".equals(token.getLexeme()))
	{tokenMap.add(new SynthaticNode(tokens.remove()));}}return tokenMap;});
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<Struct2>",tokens).getTokenNode());}return tokenMap;});

	this.functions.put("<Para1>",tokens->{
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(token!=null&&",".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<Parametro>",tokens).getTokenNode());if(token!=null&&")".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<F2>",tokens).getTokenNode());}return tokenMap;});

	this.functions.put("<Comandos>",tokens->{
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(this.predict("<IdentificadorComandos>",tokens.peek()))
	{
	...
	}else if(this.predict("<Condicional>",tokens.peek()))
	{
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(this.predict("<F>",tokens.peek()))
	{
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(this.predict("<ExpressaoLR>",tokens.peek()))
	{
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<ValorVetor>",tokens).getTokenNode());if(token!=null&&"]".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<Matriz>",tokens).getTokenNode());}return tokenMap;});
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<ArgumentoLR2_1>",tokens).getTokenNode());if(token!=null&&"true".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}if(token!=null&&"false".equals(token.getLexeme()))
	{tokenMap.add(new SynthaticNode(tokens.remove()));}}return tokenMap;});
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<Corpo>",tokens).getTokenNode());}return tokenMap;});

	this.functions.put("<Inicio>",tokens->{
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(this.predict("<Const>",tokens.peek()))
	{
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(this.predict("<Tipo>",tokens.peek()))
	{
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(token!=null&&"String".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<ListaParametros>",tokens).getTokenNode());if(token!=null&&"".equals(token.getLexeme()))
	{tokenMap.add(new SynthaticNode(tokens.remove()));}}return tokenMap;});

	this.functions.put("<Read>",tokens->{
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(token!=null&&"read".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}if(token!=null&&"(".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<Read1>",tokens).getTokenNode());}return tokenMap;});
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<T2>",tokens).getTokenNode());tokenMap.add(this.call("<E2>",tokens).getTokenNode());if(token!=null&&"--".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<T2>",tokens).getTokenNode());tokenMap.add(this.call("<E2>",tokens).getTokenNode());if(this.predict("<T2>",tokens.peek()))
	{
		tokenMap.add(this.call("<T2>", tokens).getTokenNode());
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(token!=null&&"const".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}if(token!=null&&" { ".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<TipoConst>",tokens).getTokenNode());if(token!=null&&"".equals(token.getLexeme()))
	{tokenMap.add(new SynthaticNode(tokens.remove()));}}return tokenMap;});

	this.functions.put("<Procedimento>",tokens->{
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(token!=null&&"procedure".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}if(token!=null&&"Id".equals(token.getLexeme()))
	{
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<Parametro>",tokens).getTokenNode());}return tokenMap;});

	this.functions.put("<IdentificadorAritmetico3>",tokens->{
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(this.predict("<Identificador2>",tokens.peek()))
	{
		tokenMap.add(this.call("<Identificador2>", tokens).getTokenNode());
		tokenMap.add(this.call("<ExpressaoAritmetica2>", tokens).getTokenNode());
		if (token != null && "(".equals(token.getLexeme())) {
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(this.predict("<Identificador>",tokens.peek()))
	{
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(this.predict("<Var>",tokens.peek()))
	{
		tokenMap.add(this.call("<Var>", tokens).getTokenNode());
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(this.predict("<T>",tokens.peek()))
	{
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(token!=null&&"function".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<Tipo>",tokens).getTokenNode());if(token!=null&&"Id".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}if(token!=null&&"(".equals(token.getLexeme()))
	{
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(token!=null&&"print".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}if(token!=null&&"(".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<Print1>",tokens).getTokenNode());}return tokenMap;});
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<IdVar>",tokens).getTokenNode());if(token!=null&&";".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<Var3>",tokens).getTokenNode());if(this.predict("<VetorDeclaracao>",tokens.peek()))
	{
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<IndiceVetor>",tokens).getTokenNode());if(token!=null&&"]".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}if(token!=null&&"".equals(token.getLexeme()))
	{tokenMap.add(new SynthaticNode(tokens.remove()));}}return tokenMap;});
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(this.predict("<Comandos>",tokens.peek()))
	{
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<AuxPrint>",tokens).getTokenNode());if(this.predict("<Identificador>",tokens.peek()))
	{
		tokenMap.add(this.call("<Identificador>", tokens).getTokenNode());
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<Print1>",tokens).getTokenNode());if(this.predict("<PrintFim>",tokens.peek()))
	{
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(this.predict("<Funcao>",tokens.peek()))
	{
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(token!=null&&"while".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}if(token!=null&&"(".equals(token.getLexeme()))
	{
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<ExpressaoAritmetica>",tokens).getTokenNode());if(token!=null&&"-".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<ExpressaoAritmetica>",tokens).getTokenNode());if(token!=null&&"".equals(token.getLexeme()))
	{tokenMap.add(new SynthaticNode(tokens.remove()));}}return tokenMap;});
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<IdConst>",tokens).getTokenNode());if(token!=null&&" ; ".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<Const3>",tokens).getTokenNode());}return tokenMap;});
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<Valor>",tokens).getTokenNode());tokenMap.add(this.call("<Const2>",tokens).getTokenNode());}return tokenMap;});

	this.functions.put("<IdentificadorComandos2_1>",tokens->{
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(this.predict("<ExpressaoAritmetica>",tokens.peek()))
	{
		tokenMap.add(this.call("<ExpressaoAritmetica>", tokens).getTokenNode());
		if (token != null && "String".equals(token.getLexeme())) {
			tokenMap.add(new SynthaticNode(tokens.remove()));
		}
		if (token != null && "Boolean".equals(token.getLexeme())) {
			tokenMap.add(new SynthaticNode(tokens.remove()));
		}
	}return tokenMap;});
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<Vetor2>",tokens).getTokenNode());tokenMap.add(this.call("<Identificador4>",tokens).getTokenNode());if(this.predict("<Identificador4>",tokens.peek()))
	{
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(token!=null&&"typedef".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<Extends>",tokens).getTokenNode());tokenMap.add(this.call("<TipoStruct>",tokens).getTokenNode());tokenMap.add(this.call("<Struct>",tokens).getTokenNode());if(token!=null&&"".equals(token.getLexeme()))
	{tokenMap.add(new SynthaticNode(tokens.remove()));}}return tokenMap;});

	this.functions.put("<IndiceVetor>",tokens->{
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(token!=null&&"IntPos".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<IdStruct>",tokens).getTokenNode());if(token!=null&&";".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<Struct3>",tokens).getTokenNode());}return tokenMap;});
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<Var4>",tokens).getTokenNode());if(this.predict("<Var4>",tokens.peek()))
	{
		tokenMap.add(this.call("<Var4>", tokens).getTokenNode());
	}return tokenMap;});
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<IdentificadorComandos2_1>",tokens).getTokenNode());if(token!=null&&"(".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<ListaParametros>",tokens).getTokenNode());if(token!=null&&")".equals(token.getLexeme()))
	{tokenMap.add(new SynthaticNode(tokens.remove()));}}return tokenMap;});
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(this.predict("<ListaParametros2>",tokens.peek()))
	{
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(token!=null&&"local".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}if(token!=null&&".".equals(token.getLexeme()))
	{
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<Read1>",tokens).getTokenNode());if(this.predict("<ReadFim>",tokens.peek()))
	{
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<Var3>",tokens).getTokenNode());}return tokenMap;});
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(this.predict("<OperadorLogico>",tokens.peek()))
	{
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(token!=null&&"var".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}if(token!=null&&"{".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<TipoVar>",tokens).getTokenNode());if(token!=null&&"".equals(token.getLexeme()))
	{tokenMap.add(new SynthaticNode(tokens.remove()));}}return tokenMap;});

	this.functions.put("<Extends>",tokens->{
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(token!=null&&"extends".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}if(token!=null&&"Id".equals(token.getLexeme()))
	{
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<Para3>",tokens).getTokenNode());if(token!=null&&"".equals(token.getLexeme()))
	{tokenMap.add(new SynthaticNode(tokens.remove()));}}return tokenMap;});
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<Var2>",tokens).getTokenNode());}return tokenMap;});
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<Vetor>",tokens).getTokenNode());if(this.predict("<Vetor>",tokens.peek()))
	{
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(token!=null&&"else".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}if(token!=null&&"{".equals(token.getLexeme()))
	{
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}tokenMap.add(this.call("<Vetor>",tokens).getTokenNode());if(token!=null&&"".equals(token.getLexeme()))
	{tokenMap.add(new SynthaticNode(tokens.remove()));}}return tokenMap;});

	this.functions.put("<ExpressaoLR2>",tokens->{
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(this.predict("<OperadorRelacional>",tokens.peek()))
	{
		tokenMap.add(this.call("<OperadorRelacional>", tokens).getTokenNode());
		tokenMap.add(this.call("<ArgumentoLR>", tokens).getTokenNode());
		tokenMap.add(this.call("<ExpressaoLR3>", tokens).getTokenNode());
	}else if(this.predict("<ExpressaoLR3>",tokens.peek()))
	{
		tokenMap.add(this.call("<ExpressaoLR3>", tokens).getTokenNode());
	}return tokenMap;});
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(this.predict("<ArgumentoLR2>",tokens.peek()))
	{
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(token!=null&&"boolean".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}if(token!=null&&"string".equals(token.getLexeme()))
	{
	...
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}if(token!=null&&"real".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}if(token!=null&&"Id".equals(token.getLexeme()))
	{tokenMap.add(new SynthaticNode(tokens.remove()));}}return tokenMap;});
	...
	SynthaticNode tokenMap = new SynthaticNode();
	Token token = tokens.peek();if(token!=null&&"Numero".equals(token.getLexeme()))
	{
		tokenMap.add(new SynthaticNode(tokens.remove()));
	}if(token!=null&&"String".equals(token.getLexeme()))
	{
