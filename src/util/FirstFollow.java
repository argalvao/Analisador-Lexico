...
public class FirstFollow {
	...
	private FirstFollow(){
		...
		this.About = "Grammar";
		this.Author = "Abel Galvão, Caique Trindade, Emerson Souza, Felipe Damascena, Pedro Brandão, Ramon Silva, Solenir Figueredo, Victor Souza";
		this.Version = "1.0";
		...
		this.first.put("Extends", new HashSet<>(Arrays.asList("{", "extends"))); // olhar
